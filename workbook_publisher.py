...
class workbook_publisher:
    def __init__(self, folder_path="./", output_path = "./db"):
        """
        """
        self.folder_path = folder_path
        self.db_path = os.path.join(folder_path, "수1-수능특강-ex+lv1.hwp")
    ...
    def publish_workbook(self):
        ...
        for _, row in df_sorted.iterrows():
            ...
            print(self.folder_path)
            print(str(row['문제집']) + "-" +  str(row['문제번호']).zfill(4)+"-A")
            print(os.path.join(self.folder_path), str(row['문제집']) + "-" +  str(row['문제번호']).zfill(4)+"-A")
        ...
        hwp.save_as("E:\\workspace\\ebs\\수특-수1-lv1.hwp", "HWP")
        hwp.save_as("E:\\workspace\\ebs\\수특-수1-lv1.hwpx", "HWPX")
...
maker = workbook_publisher("C:\\Data\\DB\\DB_src_2", "C:\\Data\\")
